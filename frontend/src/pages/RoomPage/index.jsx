    ...
    <div className="row mx-auto">
      ...
      {openUserTab && (
        ...
        >
          <button 
          type="button" 
          onClick = {() => setOpenUserTab(false)} className="btn btn-light btn-block w-100 mt-5">
            Close
          </button>
      ...
      {user?.presenter && (
        <div className="col-md-10 mx-auto px-5 d-flex align-items-center justify-content-center"
        >
          ...
          <div className="co-md-3 d-flex gap-2 ">
            <button
